...
new_post_ext    = "md" #"markdown"  # default new post file extension when using the new_post task
new_page_ext    = "md" #"markdown"  # default new page file extension when using the new_page task
